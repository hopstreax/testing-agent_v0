  ...
  return (
    <div className="flex flex-col gap-2 pt-1">
      <div className="flex items-center justify-between text-[11px] select-none">
        <div className="flex items-center gap-1.5 font-mono font-semibold tracking-wider text-zinc-400 uppercase">
      ...
      <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-3">
        {QUICK_PROMPTS.map((item) => (
          <button
            ...
            className="group flex flex-col items-start gap-1.5 rounded-lg border border-[#1b2026] bg-[#0d1013] p-3 text-left shadow-[inset_0_1px_0_0_rgba(255,255,255,0.02)] transition-all duration-150 hover:-translate-y-0.5 hover:border-[#00e599]/40 hover:bg-[#121518] hover:shadow-md hover:shadow-[#00e599]/5 active:scale-[0.99] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#00e599] disabled:opacity-50 cursor-pointer"
          >
